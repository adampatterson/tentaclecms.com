        ...
        <div class="container">
            ...
            <div class="row">
                <div class="span5">
                    ...
                    <p class="lead">
                        <br /><a href="<?= BASE_URL ?>download/" onClick="ga('send', 'event', 'Button', 'Download <?= release_version() ?>', 1); mixpanel.track('Content', { 'Button': 'Download', 'version': '<?= release_version() ?>' });" class="btn btn-primary btn-large btn-block">&nbsp;&nbsp;&nbsp;Download <?= release_version() ?>&nbsp;&nbsp;&nbsp;</a>
                    </p>
                </div>
